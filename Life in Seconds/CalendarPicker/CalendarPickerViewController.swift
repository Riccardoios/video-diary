...
class CalendarPickerViewController: UIViewController {
  ...
  private lazy var collectionView: UICollectionView = {
    ...
    // no spacing between its cells
    
    let collectionView = UICollectionView(frame: .zero, collectionViewLayout: layout)
    
    collectionView.isScrollEnabled = false
    collectionView.translatesAutoresizingMaskIntoConstraints = false
    //  since you’ll create your own constraints for it.
  ...
  override func viewDidLoad() {
    ...
    NSLayoutConstraint.activate([
      ...
      collectionView.heightAnchor.constraint(equalTo: view.heightAnchor, multiplier: 0.5), // heigh half of the super view
      
      
      //dimmedbagoud view constraint
